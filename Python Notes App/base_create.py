...
name_personal = ['Oliver', 'Jack', 'Harry', 'Jacob', 'Charlie', 'Thomas', 'Oscar', 'William', 'James', 'George',
                 'Amelia', 'Olivia', 'Emily', 'Ava',
                 'Jessica', 'Isabella', 'Sophie', 'Mia', 'Ruby', 'Lily']  # Библиотека имен, фамилий - ниже.
surname = ['Smith', 'Johnson', 'Williams', 'Jones', 'Brown', 'Davis', 'Miller', 'Wilson', 'Moore', 'Taylor', 'Anderson',
           'Thomas', 'Jackson', 'White', 'Harris',
           'Martin', 'Thompson', 'Wood', 'Lewis', 'Scott', 'Cooper', 'King', 'Green', 'Walker', 'Edwards', 'Turner',
           'Morgan', 'Baker', 'Hill', 'Phillips']
...
def list_of_numbers():  # Генерация телефонных номеров
    randomListPhone = random.randint(9010000000, 9090000000)
...
def string_creation():  # Cоставление строки на каждого человека
    ...
    s = temp1 + ',' + temp2 + ',' + list_of_numbers() + ',' + temp1 + temp2 + str(
        random.randint(1001, 9999)) + random.choice(ls_e_mail)
    return s
